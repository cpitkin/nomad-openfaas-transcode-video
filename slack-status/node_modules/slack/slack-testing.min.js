...
class Slack{constructor(){function _execWithToken(method,params,callback){params.token=params.token||xxx.token
...
if("testing"==='testing'){origin='http://localhost:3000'}
